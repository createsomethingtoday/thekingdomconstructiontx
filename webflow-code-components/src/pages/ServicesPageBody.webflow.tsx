...
export default declareComponent(ServicesPageBody, {
  name: "Services Page Body",
  description: "Full Services index layout with shared page chrome (nav + footer). Uses a structured multiline list for services + FAQ.",
  ...
  props: {
    ...
    heroEyebrow: props.Text({ name: "Eyebrow", defaultValue: "Painting and Handyman Services", group: "Hero" }),
    heroHeadline: props.Text({ name: "Headline", defaultValue: "Services built for busy homes", group: "Hero" }),
    heroBody: props.Text({
      name: "Body",
      defaultValue: "Pick the service you need. We’ll confirm scope, timeline, and next steps fast.",
      group: "Hero",
    }),
    ...
    trustBadges: props.Text({
      name: "Badges (one per line)",
      defaultValue: "Fast scheduling\nClean sites\nClear estimates\nTrusted crews",
      group: "Trust",
    }),

    servicesHeading: props.Text({ name: "Heading", defaultValue: "What we offer", group: "Services" }),
    servicesBody: props.Text({
      name: "Body",
      defaultValue: "Edit the list below: Title | Summary | /link",
      group: "Services",
    }),
    servicesItems: props.Text({
      name: "Services List",
      defaultValue:
        "Interior Painting | Precision prep, clean lines, durable finishes | /services\nExterior Painting | Weather-ready coatings for curb appeal | /services\nCabinet Refinishing | Factory-smooth spray finishes | /services\nHandyman Repairs | Quick fixes, clear communication | /services",
      group: "Services",
    }),
    servicesCtaLabel: props.Text({ name: "Card CTA Label", defaultValue: "Explore Service", group: "Services" }),

    faqHeading: props.Text({ name: "Heading", defaultValue: "FAQ", group: "FAQ" }),
    faqBody: props.Text({
      name: "Body",
      defaultValue: "Edit the list below: Question :: Answer",
      group: "FAQ",
    }),
    faqItems: props.Text({
      name: "FAQ List",
      defaultValue:
        "Do you offer free estimates? :: Yes. Estimates are free and we’ll confirm scope before scheduling.\nHow soon can you start? :: Start times vary, but we aim for fast scheduling when availability allows.\nDo you provide materials? :: Yes. We can supply paint and materials or work with your preferred brands.",
      group: "FAQ",
    }),

    quoteHeadline: props.Text({ name: "Headline", defaultValue: "Want a fast quote?", group: "Quote Strip" }),
