...
export default declareComponent(ReviewsPageBody, {
  name: "Reviews Page Body",
  description: "Full Reviews index layout with shared page chrome (nav + footer). Edit reviews via a structured multiline list.",
  ...
  props: {
    ...
    heroEyebrow: props.Text({ name: "Eyebrow", defaultValue: "Reviews", group: "Hero" }),
    heroHeadline: props.Text({ name: "Headline", defaultValue: "Clients trust the finish", group: "Hero" }),
    heroBody: props.Text({
      name: "Body",
      defaultValue: "See what homeowners across DFW say about our scheduling, prep, and final result.",
      group: "Hero",
    }),
    ...
    reviewsEyebrow: props.Text({ name: "Eyebrow", defaultValue: "Verified reviews", group: "Reviews" }),
    reviewsHeading: props.Text({ name: "Heading", defaultValue: "Real feedback from real projects", group: "Reviews" }),
    reviewsBody: props.Text({
      name: "Body",
      defaultValue: "Edit the list below: Quote | Name | City, ST | Project type | Rating",
      group: "Reviews",
    }),
    reviewsItems: props.Text({
      name: "Reviews List",
      defaultValue:
        "“Clean work, on time, and the lines are perfect.” | Taylor N. | Dallas, TX | Interior painting | 5\n“Great communication and the finish looks new.” | Jordan P. | Plano, TX | Cabinet refinishing | 5\n“Fast turnaround and the exterior held up through storms.” | Morgan C. | Frisco, TX | Exterior painting | 5\n“Prep was meticulous and the result is flawless.” | Alex R. | Grapevine, TX | Trim + doors | 5",
      group: "Reviews",
    }),
    reviewsShowProjectTag: props.Visibility({ name: "Show Project Tag", defaultValue: true, group: "Reviews" }),

    quoteHeadline: props.Text({ name: "Headline", defaultValue: "Want a finish like this?", group: "Quote Strip" }),
