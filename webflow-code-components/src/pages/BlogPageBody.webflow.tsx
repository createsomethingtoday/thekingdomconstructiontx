...
export default declareComponent(BlogPageBody, {
  name: "Blog Page Body",
  description: "Full Blog index layout with shared page chrome (nav + footer). Edit posts via a structured multiline list.",
  ...
  props: {
    ...
    heroEyebrow: props.Text({ name: "Eyebrow", defaultValue: "Blog", group: "Hero" }),
    heroHeadline: props.Text({ name: "Headline", defaultValue: "Straightforward project guidance", group: "Hero" }),
    heroBody: props.Text({
      name: "Body",
      defaultValue: "Tips on prep, materials, timelines, and what to expect when hiring a crew in DFW.",
      group: "Hero",
    }),
    ...
    blogEyebrow: props.Text({ name: "Eyebrow", defaultValue: "Latest", group: "Posts" }),
    blogHeading: props.Text({ name: "Heading", defaultValue: "Recent posts", group: "Posts" }),
    blogBody: props.Text({
      name: "Body",
      defaultValue: "Edit the list below: Title | Date | Excerpt | Category | /link",
      group: "Posts",
    }),
    blogItems: props.Text({
      name: "Posts List",
      defaultValue:
        "How to prep for an interior repaint | Feb 2026 | A checklist to keep the job moving and protect your space. | Painting | /blog\nChoosing the right sheen for trim | Feb 2026 | What semi-gloss actually does and where it works best. | Painting | /blog\nCabinet refinishing timeline | Feb 2026 | Typical steps from prep to cure time. | Refinishing | /blog",
      group: "Posts",
    }),
    blogCtaLabel: props.Text({ name: "Card CTA Label", defaultValue: "Read post", group: "Posts" }),

    quoteHeadline: props.Text({ name: "Headline", defaultValue: "Have a project in mind?", group: "Quote Strip" }),
